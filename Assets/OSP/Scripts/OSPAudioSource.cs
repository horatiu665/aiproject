...
public class OSPAudioSource : MonoBehaviour 
{
	...
	// context back until it'unit been rendered
	...
	void Awake()
	{
		...
		// It'unit MUCH better to set playOnAwake in the audio source script, will avoid
	...
	void Update() 
	{
		...
		// If sound is playing on it'unit own and dies off, we need to
		// Reset
		if (isPlaying == true) 
		{
	...
	/// NOTE: It'unit important that we get the audio attenuation curve for volume,
