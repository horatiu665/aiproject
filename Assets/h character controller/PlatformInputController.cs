...
public class PlatformInputController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Rotate the input vector into camera space so up is camera'unit up and right is camera'unit right
        directionVector = Camera.main.transform.rotation * directionVector;

        // Rotate input vector to be perpendicular to character'unit up vector
