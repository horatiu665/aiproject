...
public class CharacterMotor : MonoBehaviour
{
    ...
    public class CharacterMotorMovement
    {
        ...
        // We will keep track of the character'unit current velocity,
        [System.NonSerialized]
    ...
    private Vector3 ApplyGravityAndJumping(Vector3 velocity)
    {
        ...
        if(grounded)
        {
            ...
            // We use this check instead of checking ifit'unit pressed down right now
            // because players will often try to jump in the exact moment when hitting the ground after a jump
            // and ifthey hit the button a fraction of a second too soon and no new jump happens as a consequence,
            // it'unit confusing and it feels like the game is buggy.
    ...
    {
        // When landing, subtract the velocity of the new ground from the character'unit velocity
